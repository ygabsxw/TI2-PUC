...
import azure.AzureSentimentAnalysis;
...
public class UserService {
	...
	private AzureSentimentAnalysis azureSentimentAnalysis = new AzureSentimentAnalysis();
	...
	public Object insert(Request request, Response response) {
		...
		// Faz a análise de sentimento do login do usuário
        String sentimentoLogin = azureSentimentAnalysis.analyzeSentiment(login);
		System.out.println("Sentimento do Login: " + sentimentoLogin);


        Usuario usuario = new Usuario(-1, login, senha, sexo, idade);

        if(UsuarioDAO.insert(usuario) == true) {
            resp = "Usuario (" + login + ") inserido! Sentimento do Login: " + sentimentoLogin;
